    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-md-9 pb-40 header-text text-center">
                <h1 class="pb-10">Paket Umrah Dan Haji</h1>
                <p>
                    Paket Umrah Dan Haji Yang Ditawarkan Di Pt Aif Putra Mandiri Bisa Dilihat :
                </p>
            </div>
        </div>	
        <div class="row">
                ...
                <div class="col-lg-4 cl-md-6">
                    <div class="single-training">
                        <div class="thumb relative">
                            ...
                            <img class="img-fluid image-responsive"  src="<?php echo base_url() ?>uploads/paket/<?php echo $p->foto ?>" alt="">
                            <a class="admission-btn" href="<?php echo site_url('Paket/pesan/'.$p->id_paket) ?>">pesan</a>	
                        </div>
                        <div class="details">
