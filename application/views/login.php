                            ...
                            if ($this->session->flashdata('berhasil')) {
                                ...
                                <div class="login-form">
                                    ...
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input class="au-input au-input--full"  name="email" placeholder="Masukan Email Yang Sudah DI Buat">
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input class="au-input au-input--full" type="password" name="password" placeholder="Masukan Password Yang Sudah Di Buat">
                                    </div>
