    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <strong>Edit Pemesanan Umroh</strong>
            </div>
            <div class="card-body card-block">
                <?php
                echo form_open_multipart('Admin/Pesan_umroh/edit');
            ...
            <div class="card-footer">
                ...
                <?php echo anchor('Admin/Pesan_umroh', '<i class="fa fa-ban"></i>Kembali', array('class' => 'btn btn-danger btn-sm')) ?>
            </div>
