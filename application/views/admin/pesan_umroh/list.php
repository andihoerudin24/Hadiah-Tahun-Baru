<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            <h2 class="title-1">Data pemesanan Umroh</h2>
                ...
                <tbody>
                    ...
                    foreach ($paket as $row):
                        ...
                        <tr>
                            ...
                            <?php endif; ?>
                            <td><?php echo anchor('Admin/Pesan_umroh/donwload/' . $row->id, 'Donwload', array('class' => 'btn btn-danger btn-sm')) ?></td>

                            <td><?php echo anchor('Admin/Pesan_umroh/edit/' . $row->id, 'Edit', array('class' => 'btn btn-info')) ?></td>
                            <td><?php echo anchor('Admin/Pesan_umroh/hapus/' . $row->id, 'Hapus', array('class' => 'btn btn-danger')) ?></td>
                        </tr>
                        <?php $no++; ?>
                    <?php endforeach; ?>
            </table>
