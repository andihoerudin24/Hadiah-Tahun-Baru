<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">Nulis Artikel</div>
            <div class="card-body">
                <div class="card-title">
                    <h3 class="text-center title-2">Isi Artikel DI Bawah Ini</h3>
                </div>
                <hr>
                  <?php echo form_open_multipart('Admin/Artikel/add','novalidate="novalidate"');
                  ...
                  ?>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="cc-exp" name="judul" required="" type="text" class="form-control cc-exp" value="" >
                    ...
                    <div>
                        <button  type="submit" name="submit" class="btn btn-lg btn-info btn-block">
                            ...
                            <span id="payment-button-amount">Simpan Artikel</span>
                        </button>
