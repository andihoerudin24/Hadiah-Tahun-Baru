    ...
    <div class="container">				
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="<?php echo site_url('Welcome') ?>">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?php echo site_url('Foto') ?>">Foto Kami</a></p>
            </div>	
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-service-page">
                    <div class="thumbs relative videowrapper">
                        <div class="overlay-bg"></div>
                        <img class="img-fluid image-responsive" src="<?php echo base_url() ?>uploads/foto/<?php echo $row->foto ?>"  alt="">
                    </div>
                    <div class="details">
                        <a href="<?php echo base_url() ?>uploads/foto/<?php echo $row->foto ?>"><h4><?php echo $row->nama_foto ?></h4></a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
