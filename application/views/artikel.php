            ...
            <div class="col-lg-8 post-list blog-post-list">
                <?php foreach ($artikel as $a): ?>
                    ...
                    <div class="single-post">
                        <img class="img-fluid" src="<?php echo base_url() ?>uploads/artikel/<?php echo $a->foto ?>" alt="">
                        <a href="<?php echo site_url('Artikel/Detail/' . $a->id_artikel) ?>">
                            <h1>
                                <?php echo $a->judul ?>
                            </h1>
                        </a>
                        <p>
                            <?php echo substr($a->isi_artikel, 0, 200) ?>
